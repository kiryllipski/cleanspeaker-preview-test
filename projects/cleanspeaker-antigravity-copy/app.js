...
document.addEventListener("DOMContentLoaded", () => {
  ...
  gesturePad.addEventListener("mousedown", (e) => {
    ...
    gesturePad.style.background = "rgba(255, 255, 255, 0.05)";
  });
    ...
    screensToClone.forEach((item) => {
      ...
      bar.innerHTML = `
        ...
        <div class="status-icons">
          <svg viewBox="0 0 24 24" style="width:12px; height:12px; fill:#fff;"><path d="M12 3c-4.97 0-9 4.03-9 9 0 2.12.74 4.07 1.97 5.61L4.35 19.4c3.9 3.51 10 3.14 13.43-.8l1.43 1.43c1.54-1.23 2.28-3.18 2.28-5.61 0-4.97-4.03-9-9-9zm0 15c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"/></svg>
          <svg viewBox="0 0 24 24" style="width:12px; height:12px; fill:#fff;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg>
          <svg viewBox="0 0 24 24" style="width:12px; height:12px; fill:#fff;"><path d="M15.67 4H14V2h-4v2H8.33C7.6 4 7 4.6 7 5.33v15.33C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V5.33C17 4.6 16.4 4 15.67 4z"/></svg>
        </div>
      `;
      ...
      if (originalScreen) {
        ...
        if (
          ...
          clonedScreen.style.background = "rgba(0, 0, 0, 0.8)";
        }
